...
// ====================================[ sec-1: primer       ]
// - description  :: ..                :
//     L1: blah | a command line program that ...
//	   L2: ..
// -------------------------------------
// - explanation  :: ..                :
...
// ====================================[ sec-3: prototypes   ]
	static int childFunc(const char *arg){
        ...
        */
	    ...
	    chroot("./app/src/main/cpp/grdl/");
	    if(chdir("/") == -1)
	        errExit("chroot ./app/src/main/cpp/grdl/");
	...
	int main(int argc, char** argv){
	    ...
	    */
	    pid = clone((int (*)(void*))childFunc, stackTop,
	                CLONE_NEWNS | CLONE_NEWPID | CLONE_NEWUTS | SIGCHLD, (void*)"/bin/zsh");
	    if (pid == -1){
	       errExit("clone");
	    }
